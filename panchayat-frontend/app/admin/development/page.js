...
import { Hammer, Plus, TrendingUp, CheckCircle, Clock, AlertTriangle, ArrowUpRight, X } from "lucide-react";
  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
        ...
        <Button onClick={() => setShowForm(!showForm)} className="bg-orange-600 hover:bg-orange-700 text-white gap-2 rounded-2xl shadow-xl shadow-orange-200">
      ...
      {/* Projects Table */}
      <Card>
        <CardHeader title="All Projects" subtitle="Click update to change progress status" />
      ...
      {updateModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 backdrop-blur-sm p-4">
          <Card className="w-full max-w-sm p-6 relative shadow-2xl border-0 animate-in fade-in zoom-in duration-200">
