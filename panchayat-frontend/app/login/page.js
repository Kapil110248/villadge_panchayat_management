        ...
        <div className="p-8 md:p-16 flex flex-col justify-center bg-white/40">
              ...
              <div className="flex flex-col gap-2">
                 ...
                 <div className="relative">
                    <input
                      ...
                      placeholder="••••••••"
                      className="w-full bg-slate-100 border-2 border-transparent pl-4 pr-12 py-3.5 text-sm font-semibold rounded-2xl transition-all focus:bg-white focus:border-primary/20 outline-none"
                      value={password}
          ...
          <div className="mt-10 text-center">
             <p className="text-slate-400 text-xs font-bold">
               Naya Sadasya? <Link href="/register" className="text-primary hover:underline font-black">Registration Request Bhejein</Link>
             </p>
          </div>
        </div>
      </div>
